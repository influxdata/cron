...
func TestRange(t *testing.T) {
		...
		},	
	{
		...
		{
			name:  "months range with skip",
			cron:  "3 47 17 9 3-11/3 *",
			start: mustParseTime("2001-01-01T12:10:10.7Z"),
			results: []time.Time{
				mustParseTime("2001-03-09T17:47:03.0Z"),
				mustParseTime("2001-06-09T17:47:03.0Z"),
				...
				mustParseTime("2002-09-09T17:47:03.0Z"),
				mustParseTime("2003-03-09T17:47:03.0Z"),
				mustParseTime("2003-06-09T17:47:03.0Z"),
				mustParseTime("2003-09-09T17:47:03.0Z"),
				mustParseTime("2004-03-09T17:47:03.0Z"),
			},
		},
		{
		...
		{
			name:  "year range",
			cron:  "3 47 17 9 1 * 2003-2007",
			start: mustParseTime("2001-01-01T12:10:10.7Z"),
			results: []time.Time{
				mustParseTime("2003-01-09T17:47:03.0Z"),
				mustParseTime("2004-01-09T17:47:03.0Z"),
				mustParseTime("2005-01-09T17:47:03.0Z"),
				mustParseTime("2006-01-09T17:47:03.0Z"),
				mustParseTime("2007-01-09T17:47:03.0Z"),
			},
		},
	}
...
func Test_Parsed_next(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "all stars wed though sun pos",
			nt:   parsit("* * * * * 4-6 *"),
			from: ts,
			want: ceilTime(ts, time.Second),
		},
		...
		},
		{
			...
			nt:   parsit("* * * * 8-10/3 * *"),
			from: ts,
			want: mustParseTime("2019-08-01T00:00:00Z"),
		},
		{
			name: "month ranges while inside the range",
			nt:   parsit("* * * * 3-10/3 * *"),
			from: ts,
			want: mustParseTime("2019-06-27T06:05:13Z"),
		},
		{
			...
			from: ts,
			want: mustParseTime("2019-08-01T00:00:02Z"),
		},
		{
			name: "more ranges while inside them",
			nt:   parsit("2-20/2 * * * 3-10/3 * *"),
			from: ts,
			want: mustParseTime("2019-06-27T06:05:14Z"),
		},
		{
